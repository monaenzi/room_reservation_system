...
export default function RoomsPage() {
    ...
    // Angenommen, das Backend liefert alle Buchungen, wir filtern hier nach bestätigten Buchungen
    const userBookings = useMemo(() => {
        return timeslots
            .filter((booking) => booking.status === 1) // optional: nur bestätigte
            .sort((a, b) => {
    ...
    // // Get user's bookings (in a real app, this would be filtered by user)
    // const userBookings = useMemo(() => {
