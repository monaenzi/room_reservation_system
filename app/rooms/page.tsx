        ...
        try {
            ...
            if (res.ok) {
                ...
                const sortedRooms = mappedRooms.sort(
                    (a: Room, b: Room) => a.room_id - b.room_id
                );
                ...
                <div className="w-full max-w-5xl space-y-6 md:space-y-10">
                    ...
                    {displayedRooms.map((room, index) => (
                        <section
                            key={room.room_id}
                            className={[
                                "rounded-2xl bg-[#dfeedd] px-4 py-5 sm:rounded-3xl sm:px-6 sm:pb-8 sm:pt-6 md:px-10 md:pt-8 shadow-xl relative",
                                !room.is_visible ? "opacity-70 border-2 border-yellow-400" : "",
                            ].join(" ")}
                        >
                            ...
                            <div
                                className={[
                                    "flex flex-col gap-6 rounded-3xl bg-[#eaf4e7] p-4 md:p-6 md:gap-8",
        ...
        `}
            ...
            >
                <div className="flex flex-col h-full p-4">
                    <h2 className="text-lg font-semibold text-[#0f692b] mb-4">
                        Raumverwaltung
                    </h2>
                                    ...
                                    <label htmlFor="room-image" className="cursor-pointer block">
                                        {imagePreview ? (
                                            <div className="flex flex-col items-center">
                                                ...
                                                />
                                                <span className="text-sm text-[#0f692b] font-medium">
                                                    Bild ersetzen
                                                </span>
                                            </div>
                                        ) : (
                            ...
                            {selectedRooms.length > 0 && (
                                <div className="mt-4 p-3 bg-red-50 rounded-lg border border-red-100">
                                    <p className="text-sm text-red-700 font-medium">
                                        {selectedRooms.length} Raum
                                        {selectedRooms.length !== 1 ? "e" : ""} zum Löschen ausgewählt
                                    </p>
                                </div>
                            )}
                        ...
                        <div className="p-6 overflow-y-auto">
                            ...
                            {roomsToHide.length > 0 && (
                                <div className="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-100">
                                    <p className="text-sm text-blue-700 font-medium">
                                        {roomsToHide.length} Raum
                                        {roomsToHide.length !== 1 ? "e" : ""} zum Ausblenden/Einblenden ausgewählt
                                    </p>
                                </div>
                            )}
                            ...
                            <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                <p className="text-sm text-gray-700">
                                    <span className="font-semibold">Hinweis:</span> Ausgeblendete Räume werden
                                    für normale Benutzer nicht angezeigt, bleiben aber im System erhalten.
                                </p>
                            </div>
                        </div>
